...
//    UIButton *picFuncButton = [UIButton buttonWithType:UIButtonTypeCustom];
//    picFuncButton.frame = CGRectMake(270, 0, 50, 50);
//    [self.view addSubview:picFuncButton];
//    picFuncButton.backgroundColor = [UIColor blueColor];
...
//        addButton.frame = CGRectMake(50, 0, 50, 50);
//        subtractButton.frame = CGRectMake(100, 0, 50, 50);
//        pauseButton.frame = CGRectMake(150, 0, 50, 50);
//        [UIView commitAnimations];
    }
    else
    {
